...
namespace InfrastructureLayer.Repositories
{
    ...
    public class MatchInformationsRepository : IMatchRepository
    {
        ...
        {
            string endpoint = $"{ApiBaseUrl}/fixtures?league={leagueId}&last={nbLast}";
        ...
        {
            string endpoint = $"{ApiBaseUrl}/fixtures?league={leagueId}&next={nbNext}";
        ...
        {
            string endpoint = $"{ApiBaseUrl}/fixtures?team={teamId}&next={nbNext}&";
